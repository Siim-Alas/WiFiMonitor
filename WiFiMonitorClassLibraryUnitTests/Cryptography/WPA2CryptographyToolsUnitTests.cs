...
namespace WiFiMonitorClassLibraryUnitTests.Cryptography
{
    ...
    {
        // CCMP test vector from https://web.mit.edu/freebsd/head/tools/regression/net80211/ccmp/test_ccmp.c
        private readonly byte[][] _tks = new byte[][] 
        {
            new byte[128 / 8]
            {
                // Test Case 1
        ...
        private readonly byte[][] _plaintextDatas = new byte[][]
        {
            new byte[]
            {
                // Test Case 1
        ...
        private readonly byte[][] _ciphertextMPDUs = new byte[][]
        {
            new byte[] 
            {
                // Test Case 1
